...
**日期**: 2026-05-01
**状态**: 当前活文档；P0 大部分已完成，P1 调度可观察性已完成，P2 模型场景绑定已完成，P3 AI 页面体验收口已完成，剩余文献阅读/对比的浏览器验收
...
- [ ] 文献阅读/对比：选择 1-2 篇文献后提问，应读取选中文献全文并返回对比结果。
  - 后端工具与结果卡片已有测试覆盖；尚缺一次明确的浏览器级选择 1-2 篇文献后提问验收。
...
1. 完成 P0 剩余的文献阅读/对比浏览器验收。
2. 继续做文献阅读/对比的真实使用链路打磨。
